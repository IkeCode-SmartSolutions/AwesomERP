...
namespace Awe.Mvc.Core.TagHelpers
{
    ...
    /// </summary>
    public class AweServiceBasedTagHelperActivator : ITagHelperActivator
    {
        /// <inheritdoc />
    ...
    /// of the application.
    /// </summary>
    public class AweFeatureTagHelperTypeResolver : TagHelperTypeResolver
    {
        ...
        public AweFeatureTagHelperTypeResolver(ApplicationPartManager manager)
        {
            if (manager == null)
            {
    ...
    public static class AweTagHelpersAsServices
    {
        public static void AddTagHelpersAsServices(ApplicationPartManager manager, IServiceCollection services)
        {
            ...
            services.Replace(ServiceDescriptor.Transient<ITagHelperActivator, AweServiceBasedTagHelperActivator>());
            services.Replace(ServiceDescriptor.Transient<ITagHelperTypeResolver, AweFeatureTagHelperTypeResolver>());
        }
    }
}
